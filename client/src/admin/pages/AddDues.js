              ...
              <form onSubmit={submissionHandler} style={{ width: "350px", margin: "auto" }}>
                ...
                <FormControl fullWidth style={{marginTop: "25px"}}>
                  ...
                  <Select
                    ...
                    id="dues_type_id" name="dues_type_id"
                    value={dues_type_id}
                    label="Dues Type"
                  ...
                  >
                    {dues_type_list.map((val, key) => {
                      return (
                        <MenuItem key={key} value={val.dues_type_id}>{val.description}</MenuItem>
                      );
                    })}
                  </Select>
                </FormControl>
                ...
                <FormControl fullWidth style={{marginTop: "25px"}}>
                  ...
                  >
                    {students_list.map((val, key) => {
                      return (
                        <MenuItem key={key} value={val.student_id}>{val.name} - {val.student_id}</MenuItem>
                      );
                    })}
                  </Select>
                </FormControl>
                ...
                <DatePicker
                  label="Deadline"
                  onChange={setDeadline} value={deadline}
